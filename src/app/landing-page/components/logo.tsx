...
export const Logo = ({ className }: { className?: string; uniColor?: boolean }) => {
    return (
        <span
            aria-label="Logo"
            className={cn('inline-block h-12 aspect-square bg-current text-foreground dark:text-[crimson]', className)}
            style={{
...
export const LogoIcon = ({ className }: { className?: string; uniColor?: boolean }) => {
    return (
        <span
            aria-label="Logo"
            className={cn('inline-block size-10 bg-current text-foreground dark:text-[crimson]', className)}
            style={{
                WebkitMask: 'url(/logo.svg) no-repeat center / contain',
                mask: 'url(/logo.svg) no-repeat center / contain',
            }}
